#!/usr/bin/env python3
"""AI 论文速读流水线：跑一次，产出一篇公众号草稿（或本地 Markdown）。
    ...
    if wechat_draft.credentials_ready():
        try:
            media_id = wechat_draft.create_draft(
                ...
                digest=f"AI 论文速读 | {explanation['one_sentence']}"[:110],
            )
...
def main() -> int:
    parser = argparse.ArgumentParser(description="AI 论文速读流水线")
